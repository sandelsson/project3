...
801003c0:	e8 9b 02 00 00       	call   80100660 <cprintf>
  cprintf("\n");
801003c5:	c7 04 24 9b 78 10 80 	movl   $0x8010789b,(%esp)
...
80101ec8:	68 82 76 10 80       	push   $0x80107682
...
8010402b:	68 9b 78 10 80       	push   $0x8010789b
...
80104058:	8b 14 85 8c 75 10 80 	mov    -0x7fef8a74(,%eax,4),%edx
      state = "???";
...
801040d3:	83 ec 10             	sub    $0x10,%esp
	...
	cprintf("System counter has been called %d times\n", countCalls);
...
801040e6:	b8 16 00 00 00       	mov    $0x16,%eax
801040eb:	c9                   	leave  
801040ec:	c3                   	ret    
...
801040fa:	68 a4 75 10 80       	push   $0x801075a4
...
80104315:	68 af 75 10 80       	push   $0x801075af
8010431a:	e8 71 c0 ff ff       	call   80100390 <panic>
    panic("popcli");
8010431f:	83 ec 0c             	sub    $0xc,%esp
80104322:	68 c6 75 10 80       	push   $0x801075c6
...
80104407:	68 cd 75 10 80       	push   $0x801075cd
...
8010445c:	68 d5 75 10 80       	push   $0x801075d5
...
80104864:	83 ec 04             	sub    $0x4,%esp
  int num;
  countCalls++;
80104867:	83 05 b8 a5 10 80 01 	addl   $0x1,0x8010a5b8
  struct proc *curproc = myproc();
8010486e:	e8 6d ef ff ff       	call   801037e0 <myproc>
80104873:	89 c3                	mov    %eax,%ebx

  num = curproc->tf->eax;
80104875:	8b 40 18             	mov    0x18(%eax),%eax
80104878:	8b 40 1c             	mov    0x1c(%eax),%eax
  if(num > 0 && num < NELEM(syscalls) && syscalls[num]) {
8010487b:	8d 50 ff             	lea    -0x1(%eax),%edx
8010487e:	83 fa 15             	cmp    $0x15,%edx
80104881:	77 1d                	ja     801048a0 <syscall+0x40>
80104883:	8b 14 85 00 76 10 80 	mov    -0x7fef8a00(,%eax,4),%edx
8010488a:	85 d2                	test   %edx,%edx
8010488c:	74 12                	je     801048a0 <syscall+0x40>
    curproc->tf->eax = syscalls[num]();
8010488e:	ff d2                	call   *%edx
80104890:	8b 53 18             	mov    0x18(%ebx),%edx
80104893:	89 42 1c             	mov    %eax,0x1c(%edx)
  } else {
...
801048a0:	50                   	push   %eax
            curproc->pid, curproc->name, num);
801048a1:	8d 43 6c             	lea    0x6c(%ebx),%eax
    cprintf("%d %s: unknown sys call %d\n",
801048a4:	50                   	push   %eax
801048a5:	ff 73 10             	pushl  0x10(%ebx)
801048a8:	68 dd 75 10 80       	push   $0x801075dd
801048ad:	e8 ae bd ff ff       	call   80100660 <cprintf>
    curproc->tf->eax = -1;
801048b2:	8b 43 18             	mov    0x18(%ebx),%eax
801048b5:	83 c4 10             	add    $0x10,%esp
801048b8:	c7 40 1c ff ff ff ff 	movl   $0xffffffff,0x1c(%eax)
}
...
80104a35:	68 6b 76 10 80       	push   $0x8010766b
...
80104a4a:	68 7a 76 10 80       	push   $0x8010767a
80104a4f:	e8 3c b9 ff ff       	call   80100390 <panic>
    panic("create: ialloc");
80104a54:	83 ec 0c             	sub    $0xc,%esp
80104a57:	68 5c 76 10 80       	push   $0x8010765c
...
80104a82:	e8 e9 fc ff ff       	call   80104770 <argint>
...
80104e0f:	e8 0c fa ff ff       	call   80104820 <argstr>
...
80104e49:	58                   	pop    %eax
80104e4a:	5a                   	pop    %edx
80104e4b:	68 78 76 10 80       	push   $0x80107678
...
80104e64:	68 77 76 10 80       	push   $0x80107677
...
80104ebe:	e8 ad f5 ff ff       	call   80104470 <memset>
  if(writei(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
...
80104fef:	e8 2c f8 ff ff       	call   80104820 <argstr>
...
80105008:	e8 63 f7 ff ff       	call   80104770 <argint>
...
80105154:	e8 c7 f6 ff ff       	call   80104820 <argstr>
...
801051c9:	e8 a2 f5 ff ff       	call   80104770 <argint>
  if((argstr(0, &path)) < 0 ||
...
801051de:	e8 8d f5 ff ff       	call   80104770 <argint>
     argint(1, &major) < 0 ||
...
8010524d:	e8 ce f5 ff ff       	call   80104820 <argstr>
...
801052f5:	e8 26 f5 ff ff       	call   80104820 <argstr>
...
80105311:	e8 5a f4 ff ff       	call   80104770 <argint>
...
80105336:	e8 35 f1 ff ff       	call   80104470 <memset>
...
80105358:	e8 a3 f3 ff ff       	call   80104700 <fetchstr>
...
80105380:	e8 3b f3 ff ff       	call   801046c0 <fetchint>
...
801053e1:	e8 da f3 ff ff       	call   801047c0 <argptr>
...
801055a5:	e8 b6 ed ff ff       	call   80104360 <acquire>
  ticks0 = ticks;
...
801055f5:	e8 26 ee ff ff       	call   80104420 <release>
      return -1;
...
8010563c:	e8 1f ed ff ff       	call   80104360 <acquire>
  xticks = ticks;
...
80105663:	5d                   	pop    %ebp
	return count();
80105664:	e9 67 ea ff ff       	jmp    801040d0 <count>
...
801056de:	00 00 ef 
  initlock(&tickslock, "time");
801056e1:	68 bd 76 10 80       	push   $0x801076bd
...
80105760:	ff 24 85 64 77 10 80 	jmp    *-0x7fef889c(,%eax,4)
...
801057c5:	68 20 77 10 80       	push   $0x80107720
...
80105907:	68 c8 76 10 80       	push   $0x801076c8
...
801059a5:	68 ec 76 10 80       	push   $0x801076ec
801059aa:	e8 b1 ac ff ff       	call   80100660 <cprintf>
      panic("trap");
801059af:	83 c4 14             	add    $0x14,%esp
801059b2:	68 c2 76 10 80       	push   $0x801076c2
...
80105aac:	83 ec 08             	sub    $0x8,%esp
  for(p="xv6...\n"; *p; p++)
80105aaf:	bb e4 77 10 80       	mov    $0x801077e4,%ebx
  ioapicenable(IRQ_COM1, 0);
...
80106999:	68 31 78 10 80       	push   $0x80107831
...
80106afd:	68 69 78 10 80       	push   $0x80107869
...
80106b33:	68 81 78 10 80       	push   $0x80107881
...
80106c3c:	68 9d 78 10 80       	push   $0x8010789d
...
80106d0f:	68 ae 78 10 80       	push   $0x801078ae
...
80106df9:	68 d2 78 10 80       	push   $0x801078d2
80106dfe:	e8 8d 95 ff ff       	call   80100390 <panic>
      panic("copyuvm: pte should exist");
80106e03:	83 ec 0c             	sub    $0xc,%esp
80106e06:	68 b8 78 10 80       	push   $0x801078b8
